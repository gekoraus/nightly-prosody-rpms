...
Name:              prosody
Version:           trunk
Release:           1.nightly554%{?dist}
License:           MIT
Group:             System Environment/Daemons
URL:               https://prosody.im/
Source0:           https://prosody.im/nightly/0.10/build139/%{name}-%{version}-1nightly554.tar.gz
...
%prep
%setup -q -n %{name}-%{version}-1nightly554
%patch0 -p1 -b .config
...
%changelog
* Wed Jun 24 2015 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly554
- Upgrade to trunk-1.nightly554
