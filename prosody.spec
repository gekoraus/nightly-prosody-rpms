...
Name:              prosody
Version:           0.10
Release:           1.nightly112%{?dist}
License:           MIT
Group:             System Environment/Daemons
URL:               https://prosody.im/
Source0:           https://prosody.im/nightly/0.10/build112/%{name}-%{version}-1nightly112.tar.gz
...
%prep
%setup -q -n %{name}-%{version}-1nightly112
%patch0 -p1 -b .config
...
%changelog
* Wed Jun 24 2015 Robert Scheck <robert@fedoraproject.org> 0.10-1.nightly112
- Upgrade to 0.10-1.nightly112
