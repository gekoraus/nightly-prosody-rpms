...
Name:              prosody
Version:           trunk
Release:           1.nightly626%{?dist}
License:           MIT
Group:             System Environment/Daemons
URL:               https://prosody.im/
Source0:           https://prosody.im/nightly/trunk/build626/%{name}-%{version}-1nightly626.tar.gz
...
%prep
%setup -q -n %{name}-%{version}-1nightly626
%patch0 -p1 -b .config
%if 0%{?rhel} == 5
%patch1 -p1
%endif
...
%changelog
* Mon Apr 04 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly626
- Upgrade to trunk-1.nightly626

* Mon Apr 04 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly625
- Upgrade to trunk-1.nightly625

* Mon Apr 04 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly624
- Upgrade to trunk-1.nightly624

* Sun Apr 03 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly623
- Upgrade to trunk-1.nightly623

* Sun Apr 03 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly622
- Upgrade to trunk-1.nightly622

* Sun Apr 03 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly621
- Upgrade to trunk-1.nightly621

* Sat Apr 02 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly620
- Upgrade to trunk-1.nightly620

* Sat Apr 02 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly619
- Upgrade to trunk-1.nightly619

* Sat Apr 02 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly618
- Upgrade to trunk-1.nightly618

* Mon Feb 01 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly617
- Upgrade to trunk-1.nightly617

* Sun Jan 31 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly616
- Upgrade to trunk-1.nightly616

* Sat Jan 30 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly615
- Upgrade to trunk-1.nightly615

* Thu Jan 28 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly614
- Upgrade to trunk-1.nightly614

* Sat Jan 23 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly613
- Upgrade to trunk-1.nightly613

* Fri Jan 22 2016 Robert Scheck <robert@fedoraproject.org> trunk-1.nightly612
- Upgrade to trunk-1.nightly612
