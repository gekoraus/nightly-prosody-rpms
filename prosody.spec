...
Name:              prosody
Version:           0.9
Release:           1.nightly236%{?dist}
License:           MIT
Group:             System Environment/Daemons
URL:               https://prosody.im/
Source0:           https://prosody.im/nightly/0.9/build236/%{name}-%{version}-1nightly236.tar.gz
...
%prep
%setup -q -n %{name}-%{version}-1nightly236
%patch0 -p1 -b .config
...
%changelog
* Wed Jun 24 2015 Robert Scheck <robert@fedoraproject.org> 0.9-1.nightly236
- Upgrade to 0.9-1.nightly236
