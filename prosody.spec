...
Name:              prosody
Version:           0.9
Release:           1.nightly233%{?dist}
License:           MIT
Group:             System Environment/Daemons
URL:               https://prosody.im/
Source0:           https://prosody.im/nightly/0.9/build233/%{name}-%{version}-1nightly233.tar.gz
...
%prep
%setup -q -n %{name}-%{version}-1nightly233
%patch0 -p1 -b .config
...
%changelog
* Wed Jun 24 2015 Robert Scheck <robert@fedoraproject.org> 0.9-1.nightly233
- Upgrade to 0.9-1.nightly233
